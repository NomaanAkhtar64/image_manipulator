...
const Layout: React.FC<LayoutProps> = ({ children, name }) => {
  ...
  const [uploadParent] = useAutoAnimate<HTMLDivElement>({
    duration: 300,
  });
  ...
  return (
    <div className='w-full h-full md:px-10  flex justify-center items-start md:items-center'>
      <div
        className='w-full h-96 py-4 bg-zinc-800 dark:bg-zinc-100 flex flex-col items-center'
        ref={uploadParent}
      >
        <h1
